...
#reg_weight=1e-3
#learning_rate=1e-3
# 3/18 killed at n_layers=3 --n_layers=3 --reg_weight=1e-3 --learning_rate=1e-3 --gpu_id=1 --tau_da=1.0 --beta_discount_factor=10 --DA_sampling=anchor --> adjust n_layers, discount, da order
for reg_weight in 1e-3 1e-4 1e-5
do
for learning_rate in 1e-3 1e-4 1e-5
do
for n_layers in 3 1 2
do
for model in LRGCCF
do
# original models
...
do
for beta_discount_factor in 50 100 200 2 10
do
for da in anchor full ui
do
